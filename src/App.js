...
<br/><br/><br/>
    {this.state.loadingStatus === "LOADING"  ? (<h3>Searching City name...</h3>) :  
    (
    (this.state.error === "Please enter the City Name." || this.state.error === "City Name not found") ?
...
/>
    ...
    :this.state.check === true ?<div><div id="information">
